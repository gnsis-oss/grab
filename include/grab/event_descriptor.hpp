    ...
    namespace detail
    {
        ...
        inline constexpr auto eventDescriptors  = std::to_array<EventDescriptor>( {
            ...
            event_descriptor( EventKind::IdleEnd,
                              ...
                              ReplayPolicy::None,
                              CoalescingClass::NeverDrop ),
            event_descriptor( EventKind::MouseButtonDown,
                              EventCategory::Input,
                              "input.mouse_button_down",
                              ReplayPolicy::None,
                              CoalescingClass::NeverDrop ),
            event_descriptor( EventKind::MouseButtonUp,
                              EventCategory::Input,
            ...
            event_descriptor( EventKind::StateSnapshot,
                              ...
                              "state.snapshot",
                              ReplayPolicy::CurrentSet ),
            event_descriptor( EventKind::NodeAdded,
                              EventCategory::Window,
                              "node.added",
                              ReplayPolicy::None,
                              CoalescingClass::NeverDrop ),
            event_descriptor( EventKind::NodeRemoved,
                              EventCategory::Window,
                              "node.removed",
                              ReplayPolicy::None,
                              CoalescingClass::NeverDrop ),
            event_descriptor( EventKind::NodeChanged,
                              EventCategory::Window,
                              "node.changed",
                              ReplayPolicy::None,
                              CoalescingClass::Coalesce ),
            event_descriptor( EventKind::RelationAdded,
                              EventCategory::Window,
                              "relation.added",
                              ReplayPolicy::None,
                              CoalescingClass::NeverDrop ),
            event_descriptor( EventKind::RelationRemoved,
                              EventCategory::Window,
                              "relation.removed",
                              ReplayPolicy::None,
                              CoalescingClass::NeverDrop ),
            event_descriptor( EventKind::ActiveChildChanged,
                              EventCategory::Window,
