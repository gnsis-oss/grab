...
namespace grab::transport
{
    ...
    inline constexpr auto protoKindRows = std::to_array<ProtoKindRow>( {
        ...
        proto_kind_row( grab::EventKind::MouseButtonDown,
                        eventgrab::v1::INPUT_MOUSE_BUTTON_DOWN ),
        proto_kind_row( grab::EventKind::MouseButtonUp,
                        eventgrab::v1::INPUT_MOUSE_BUTTON_UP ),
